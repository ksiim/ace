  ...
  const benefits: BenefitItem[] = [
    {
      ...
      description: 'Два месяца бесплатного доступа ко всем функциям платформы.'
    },
    {
      title: 'Гибкие тарифы',
      description: 'Выберите оптимальный тариф: 1 месяц за 199 ₽, 6 месяцев за 1100 ₽ или 12 месяцев за 2100 ₽.'
    },
    {
